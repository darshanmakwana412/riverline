...
4. Create the docs write down the detailed analysis which you did, the initial section should contain the list of bug, gaps, limitations, false postivve, false negative you found out and any things which are incorrect/wrong and in the next section go on in detail and explain what exactly is wrong, incorrect, gap, etc with exact conversation source and exact description of the scenario and why is it wrong according to the spec, this is to make sure is reproducable and documented